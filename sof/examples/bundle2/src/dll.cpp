...
{				
	...
	{
	  LoggerFactory::getLogger( "Test" ).log( Logger::DEBUG, "[bundle2_dll#DllMain] Called, dll thread detach." );
	}

	if(ul_reason_for_call==DLL_PROCESS_ATTACH)
	{
	  LoggerFactory::getLogger( "Test" ).log( Logger::DEBUG, "[bundle2_dll#DllMain] Called, dll process attach." );
	}

	if(ul_reason_for_call==DLL_PROCESS_DETACH)
	{
	  LoggerFactory::getLogger( "Test" ).log( Logger::DEBUG, "[bundle2_dll#DllMain] Called, dll process detach." );
	}

	LoggerFactory::getLogger( "Test" ).log( Logger::DEBUG, "[bundle2_dll#DllMain] Left." );
	return TRUE;
}
